...
| **E2E agent** | `apps/tests/test_agent_field_e2e.py` | Création agent-only → pending → validate/reject → carte + `client_id` |
| Playwright | `frontend/e2e/` | Filtre validation carte (API mockée) ; `npm run test:e2e` |
